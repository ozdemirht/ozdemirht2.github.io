...
The column 160 (classe) is response/output (activity class label).
...
```
The estimated out of sample (generalization) error rate[2] is (100.0-98.2=1.8%).
...
Then, we tried to fit a random forest. This model produced 100% accurate prediction for training set and 98.2% accurate prediction for test set.
